  ...
  return (
    <div className=" landingBG mx-auto px-4 w-[100%] lg:px-[20%] py-8 text-white  font-Comfortaa">
      ...
      <p className="mb-4">
        ...
        Analysedienste ein. Nähere Erläuterungen dazu erhalten Sie weiter unten
      ...
      <p className="mb-4">
        ...
        <br />– dies gesetzlich zulässig und nach Art. 6 Abs. 1 S. 1 lit. b
      ...
      <p className="mb-4">
        ...
        gespeichert werden, wenn Sie unsere Seiten besuchen. Cookies richten auf
        Ihrem Endgerät keinen Schaden an, enthalten keine Viren, Trojaner oder
        sonstige Schadsoftware. In dem Cookie werden Informationen abgelegt, die
        ...
        nicht zur Erstellung von Nutzerprofilen verwendet. Die Verwendung von
        Analyse-Cookies erfolgt zu dem Zweck, die Qualität unserer Website und
        ihre Inhalte zu verbessern. Durch die Analyse-Cookies erfahren wir, wie
        die Website genutzt wird und können so unser Angebot stetig optimieren.
        <br />
        <br />
        Diese Zwecke begründen auch unser berechtigtes Interesse an der
        ...
        <br />
        <br />
        d) Sie können Ihre Cookie-Einstellungen jederzeit anpassen und z.B. die
        Annahme von Third-Party-Cookies oder allen Cookies ablehnen. Wir weisen
        ...
        installieren. Die Nutzung von HTML5 storage objects können Sie
      ...
      <p className="mb-4">
        ...
        <br />– gemäß Art. 77 DS-GVO sich bei einer Aufsichtsbehörde zu
        beschweren. Zuständig ist die Aufsichtsbehörde Ihres üblichen
      ...
      <p className="mb-4">
        ...
        an der geschlossenen Darstellung des Schlüssel- beziehungsweise
      ...
      <p className="mb-4">
        ...
        2022. Durch die Weiterentwicklung unserer Website und Angebote darüber
        ...
        Die jeweils aktuelle Datenschutz-Erklärung kann jederzeit auf der
