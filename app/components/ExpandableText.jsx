...
const ExpandableText = ({ children, maxLength = 900 }) => {
  ...
  return (
    <div className="text-third text-[.8rem] mx-auto mt-2 relative">
      <div
      ...
      {needsTruncation && (
        <button
          ...
          className="text-third font-black cursor-pointer bg-white mx-auto mt-4 flex items-center hover:bg-slate-200 p-4 rounded-2xl transition duration-300 ease-in-out z-0 "
        >
          {isExpanded ? (
            <>
